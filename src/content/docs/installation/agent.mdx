...
docker cp $(docker create --rm ghcr.io/easyshell-ai/easyshell/easyshell-server:latest):/opt/easyshell/agent-binaries/easyshell-agent-linux-amd64 ./easyshell-agent
