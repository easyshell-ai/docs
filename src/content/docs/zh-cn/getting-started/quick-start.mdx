...
本指南将带你使用 Docker Compose 一键部署完整的 EasyShell 环境。所有服务（Server、Web、MySQL、Redis）均已容器化，预构建镜像通过 GitHub Actions 自动发布到 [Docker Hub](https://hub.docker.com/u/laolupaojiao) 和 GHCR。
